...
const OrdersList: React.FC<OrderListProps> = ({ pageId }) => {
  ...
  function handleFilterDate(e: any) {
    ...
    if (e.target.name === "desde") {
      setFilterSelected((prevFilter) => ({
        ...prevFilter,
        createdAt: { ...prevFilter?.createdAt, $gte: date },
      }));
    } else if (e.target.name === "hasta") {
      setFilterSelected((prevFilter) => ({
        ...prevFilter,
        createdAt: { ...prevFilter?.createdAt, $lte: date },
      }));
    }
  }
          ...
          >
            <div className="d-flex column gap-3">
              ...
              <div>
                ...
                <Form.Select
                  ...
                  value={
                    filterSelected?.isPaid === true
                      ? "true"
                      : filterSelected?.isPaid === false
                      ? "false"
                      : ""
                  }
              ...
              <div>
                ...
                <Form.Select
                  ...
                  value={
                    filterSelected?.isDelivered === true
                      ? "true"
                      : filterSelected?.isDelivered === false
                      ? "false"
                      : ""
                  }
            ...
            <div className="d-flex justify-content-end">
              <div className="d-flex gap-3">
                <Button type="submit" style={{ backgroundColor: "#a2cca6" }}>
                  {" "}
                  Filtrar{" "}
                </Button>
                <Button
