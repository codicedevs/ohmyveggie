      ...
      <div className="columns-2 w-row">
        <div className="column-5 w-col w-col-8 px-0">
          <div className="orderitem">
            ...
            <div className="txtordersubitem">Teléfono: <b>{cart.data.shippingDetails.telephone} </b></div>
            <div className="txtordersubitem">Forma de entrega: <b>{cart.data.shippingDetails.timeDeliver}</b> </div>
