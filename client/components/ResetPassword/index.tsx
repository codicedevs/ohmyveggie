...
import { ActionTypes } from "../../state/Cart/cart.action-types";
import { ActionTypes as UAT } from "../../state/User/user.action-types";
    ...
    <section style={{ display: "flex" }} className="login">
      {isAlertVisible ? (
        <Alert style={{ width: "50%" }} variant="success">
          ...
          <p>
            Se le enviará un email a <b>{uI.emailForRecover}</b> con un código
        ...
        <div className="div-block-35">
          ...
          <div className="form-block w-form">
            ...
            >
              ...
              <text className="logintextfield w-input" type="text">
                {uI.emailForRecover}
              </text>
              ...
              <button
                ...
                disabled={loading}
              >
                {loading ? <Loader size={15} color={"white"} /> : "Enviar"}
              </button>
            </form>
          </div>
          ...
          <div
            ...
            onClick={() => {
              dispatch({ type: AT.CLOSE_RESET_PASSWORD });
              dispatch({ type: UAT.RECOVER_PASSWORD_SUCCESS });
            }}
          >
            X
          </div>
