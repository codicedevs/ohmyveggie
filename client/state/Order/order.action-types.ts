export enum ActionTypes {
  ...
  CREATE_PAYMENT_PREFERENCE_START = 'CREATE_PAYMENT_PREFERENCE_START',
  CREATE_PAYMENT_PREFERENCE_SUCCESS = 'CREATE_PAYMENT_PREFERENCE_SUCCESS',
  CREATE_PAYMENT_PREFERENCE_ERROR = 'CREATE_PAYMENT_PREFERENCE_ERROR',
}
